// ============================================================
// Buck Converter Socket — Test Print
...
buck_socket_wall = 3;
buck_clearance   = -3.5;    // 13.5mm inner gap
...
inner_w    = buck_w + buck_clearance; // 13.5mm
w          = buck_socket_wall;
...
echo(str("Groove: ", groove_h, "mm tall, ", groove_d, "mm deep, ledge at ", ledge_h, "mm"));
